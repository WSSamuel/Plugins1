...
Version 1.4 includes many user requested features. Check <a href="http://justmyecho.com/2010/07/top-contributors-plugin-wordpress/">plugin webpage</a> for details on the update.
...
Support and Feature request forum at http://justmyecho.com/forums/
...
== Changelog ==
= 1.4.1 =
* Fixed bug where error was produced when minimum comment threshold was not met
= 1.4 =
* Added many new user requested features, check plugin page for details.
= 1.3.1 =
...
= 1.4.1 =
Fixed bug with commenter icon comment threshold
= 1.4 =
Added many new user requested features. Check plugin page for details.
= 1.3.1 =
Fixed a bug with widget caching
