...
1. A filter with posts count and terms hierarchy
2. All filters displayed on an custom post type admin edit screen
...
= GitHub Plugin URI =
Visit our GitHub page @ [https://github.com/amarinediary/CPT-Admin-Taxonomy-Filtering](https://github.com/amarinediary/CPT-Admin-Taxonomy-Filtering).
...
3. [Download the plugin as a zip file](https://downloads.wordpress.org/plugin/cpt-admin-taxonomy-filtering.zip), Select it from your local filesystem.
