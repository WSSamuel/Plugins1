<div class="modal fade" id="icreon-import-capability" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form name="icreon_import_capability" method="POST" id="icreon_import_capability"
                  enctype="multipart/form-data">
                <input type="hidden" name="icreon_role_cap_action" value="import_capability"/>
                <?php wp_nonce_field('icreon_import_capability', 'icreon_import_capability_nonce'); ?>
                ...
                <div class="modal-footer"></span>
                    ...
                    <button type="submit" id="btn-icreon-export-role"
