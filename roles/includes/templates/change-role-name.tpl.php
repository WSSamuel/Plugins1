...
foreach($this->roles as $role_id => $role_val) {
    ?>
    <div class="modal fade" id="icreon-change-role-name-<?php print $role_id; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form name="icreon_change_default_role_name" method="POST" id="icreon_change_default_role_name">
                    <input type="hidden" name="icreon_role_cap_action" value="change_role_display_name"/>
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="submit" id="btn-icreon-add-role"
