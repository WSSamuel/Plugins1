...
<input type="hidden" name="icreon_user_role_cap_action" value="user_role_cap" />
<?php wp_nonce_field('icreon_user_role_cap', 'icreon_user_role_cap_nonce'); ?>
                    ...
                    <div class="menu-edit ">
                        ...
                        <div id="post-body">
                            <div id="post-body-content">
                                ...
                                <?php foreach ($this->roles_capabilities_function->icreon_roles_capabilities_get_built_in_capabilities() as $built_in_caps) { ?>
                                ...
                                <div class="user-role-cap">
                                    <input type="checkbox"  name="cap[<?php print $cap['name']; ?>]" <?php print $this->roles_capabilities_function->icreon_roles_capabilities_check_user_cap($this->user, $user_capability_from_role, $cap['name']); ?> />
                                ...
                                <div class="user-role-cap-parent">
                                    ...
                                    <?php foreach ($this->roles_capabilities_function->icreon_roles_capabilities_get_other_capabilities() as $cap){ ?>
                                        <div class="user-role-cap">
                                        <input type="checkbox" name="cap[<?php print $cap; ?>]" <?php print $this->roles_capabilities_function->icreon_roles_capabilities_check_user_cap($this->user, $user_capability_from_role, $cap); ?> >
                                    ...
                                    <?php } ?>
                                     ...
                                     <?php foreach ($hidden_cap as $cap){ ?>
                                        <div class="user-role-cap">
                                        <input type="checkbox" name="cap[<?php print $cap; ?>]" <?php print $this->roles_capabilities_function->icreon_roles_capabilities_check_user_cap($this->user, $user_capability_from_role, $cap); ?> > <?php print $cap; ?>
                                        </div>
                                    <?php } ?>
                                </div>
                        ...
                        <div id="nav-menu-footer">
                            <div class="major-publishing-actions icreon-pc">
                                <div class="publishing-action">
                                    <input type="submit" value="<?php _e('Save Roles and Capabilities', $this->translation_domain); ?>" class="button button-primary menu-save" id="save_menu_header" name="save_role_cap" >
                                </div>
                            </div>
