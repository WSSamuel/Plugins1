<div class="modal fade" id="icreon-change-default-role" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form name="icreon_change_default_role"  method="POST" id="icreon_change_default_role" >
                <input type="hidden" name="icreon_role_cap_action" value="change_default_role" />
                <?php wp_nonce_field('icreon_change_default_role','icreon_change_default_role_nonce'); ?>
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" id="btn-icreon-add-role"  class="btn btn-primary"><?php _e('Change Default Role', $this->translation_domain); ?></button>
                </div>
            </form>
        </div>
    </div>
