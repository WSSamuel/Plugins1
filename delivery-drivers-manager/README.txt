...
Tags: delivery, delivery manager, drivers, woocommerce, shipping
...
Developed by [PowerfulWP](https://powerfulwp.com/) | [Premium](https://powerfulwp.com/delivery-drivers-manager/) | [Documents](https://powerfulwp.com/docs/delivery-drivers-manager/)
...
## * PREMIUM FEATURES
Check out the [Delivery Drivers Manager Premium](https://powerfulwp.com/delivery-drivers-manager/) plugin.
...
1. Go to users page on the admin panel and create a new user with a delivery manager role.
1. On the edit user page set Manager account status to active and choose a manager drivers option.
1. Go to the local delivery plugin settings and click on the Manager settings tab
1. On this page you have the delivery manager panel link, send it to the delivery manager.
1. The delivery manager can log in to the delivery manager panel and start working.


== Frequently Asked Questions ==

== Screenshots ==
1. Premium - Delivery Drivers Manager Dashboard.
1. Premium - Delivery Drivers Routes.
1. Premium - Manage Delivery Drivers.
1. Premium - Manage Orders.
1. Premium - Manage Order.
1. Premium - Delivery Drivers Manager Reports.
