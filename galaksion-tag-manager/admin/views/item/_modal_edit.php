...
<div class="glxtmModalBox">
    ...
    <div class="glxtmModalBox_title"><?= esc_html__('Edit Code', 'galaksion-tag-manager') ?></div>
    <form
        action="<?= AdminUrl::toAjax('glxtm_edit_item', ['id' => $itemId]) ?>"
        data-ajax-form="1"
    >
        ...
        <div class="glxtmModalBox_footer">
            <div class="glxtmModalBox_footer_buttons">
                ...
                <?= AdminHtml::button(esc_html__('Save', 'galaksion-tag-manager'), [
