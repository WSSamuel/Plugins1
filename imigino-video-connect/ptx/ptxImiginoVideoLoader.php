<?php
    ...
    class ptxImiginoVideoLoader {
        ...
        public function addShortcode($hook, $component, $callback): void {
            $this->shortcodes = $this->add($this->shortcodes, $hook, $component, $callback, $priority = 10, $acceptedArgs = 1);
        }
        ...
        public function removeAction($hook, $component, $callback): void {
            $this->shortcodes = $this->add($this->removeActions, $hook, $component, $callback, $priority = 10, $acceptedArgs = 1);
        }
        ...
        public function removeFilter($hook, $component, $callback): void {
            $this->shortcodes = $this->add($this->removeFilters, $hook, $component, $callback, $priority = 10, $acceptedArgs = 1);
        }
