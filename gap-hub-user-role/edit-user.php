...
/*
 * 
 * User role plugin: user capabilities editor page
 * @since 3.4.1
 * @package wordpress
 */
...
<script language="javascript" type="text/javascript">
  function ure_Actions(action, value) {
    var url = '<?php echo URE_WP_ADMIN_URL.'/'.URE_PARENT; ?>?page=user-role.php&object=user&user_id=<?php echo $ure_userToEdit->ID; ?>';
    if (action=='cancel') {
...
<?php
  ...
  $userInfo .= '</span>';
	displayBoxStart(__('Change capabilities for user', 'ure').$userInfo);
